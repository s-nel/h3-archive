...
import { isArray, isDateLike, isString } from '@elastic/eui/lib/services/predicate';
import { keysOf } from '@elastic/eui';
import {
  AST,
  FieldClause,
  IsClause,
  ...
  Value,
  _AST,
} from '@elastic/eui/lib/components/search_bar/query';
import { printIso8601 } from '@elastic/eui/lib/components/search_bar/query/date_format';
import { dateValue, DateValue, isDateValue } from '@elastic/eui/lib/components/search_bar/query/date_value';
